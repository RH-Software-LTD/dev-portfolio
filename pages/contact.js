...
function contact() {
  return (
    ...
    <section className='p-8 bg-black'>
        <section className='bg-blueText rounded-tl-2xl rounded-tr-2xl'>
            <nav className='flex flex-row rounded-tl-2xl rounded-tr-2xl border-b-[1px] border-[#607B96]'>
                <h1 className='p-4 text-grayText'>harun-inam</h1>
                <hr class="border-gray-200 sm:mx-16 dark:border-gray-700" />
                <div className='flex flex-row'>
                    <div className='flex flex-row p-4 border-x-[1px] border-[#607B96] text-[#607B96]'>
                        <a className='mx-4 font-semibold' href='/'>_hello</a>
                    </div>
                    <div className='flex flex-row font-semibold p-4 border-r-[1px] border-[#607B96] text-[#607B96]'>
                        <a className='mx-4' href='#'>_about-me</a>
                    </div>
                    <div className='flex flex-row font-semibold p-4 border-r-[1px] border-[#607B96] text-[#607B96]'>
                        <a className='mx-4'>_projects</a>
                    </div>
                </div>
                <hr class="border-gray-200 sm:mx-auto lg:my-2" />
                <div className='flex flex-row font-semibold p-3 border-l-[1px] border-[#607B96] text-[#607B96] border-b-2 border-b-[#FEA55F] '>
                    <a className='mx-2 my-auto justify-end text-white' href='/contact'>_contact-me</a>
                </div>
            </nav>
            <div className='flex flex-col'>
                <div className='flex flex-row p-3 items-center gap-2 border-b-[1px] border-[#607B96]'>
                ...
                <div className='p-3 border-b-[1px] border-[#607B96]'>
                    <div className="text-[#607B96] flex flex-row gap-2 items-center hover:text-white mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-card-text" viewBox="0 0 16 16">
                            <path d="M14.5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h13zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
                            <path d="M3 5.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zM3 8a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 3 8zm0 2.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5z"/>
                        </svg>
                        <a href='mailto:user@gmai.com'>user@gmail.com</a>
                    </div>
                    <div className="text-[#607B96] flex flex-row gap-2 items-center hover:text-white mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
                        </svg>
                        <a href='tel:user@gmai.com'>+3598246359</a>
                    </div>
                </div>
            </div>
            <div className='flex flex-col'>
